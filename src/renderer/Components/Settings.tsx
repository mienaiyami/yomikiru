                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a
                                                    onClick={() => {
                                                        scrollIntoView(
                                                            "#settings-usage-searchShortcutKeys",
                                                            "extras"
                                                        );
                                                    }}
                                                >
                        ...
                        <div className={`tab ${currentTab === TAB_INFO.extras[0] ? "selected " : ""}`}>
                            ...
                            <div className="content2 features">
                                <ul>
                                    ...
                                    <li>
                                        <b>Recommended File Arrangement:</b> Though you can open manga from
                                        anywhere, it is recommended to arrange file in way as shown below for
                                        better experience and features like "reader side-list".
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                Dropping a folder will open the reader with that folders content.
                                            </li>
                                            <li>
                                    ...
                                    <li id="settings-usage-searchShortcutKeys">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <code>F10</code>) or <code>ContextMenu/Menu</code> buttons to get
                                                right click menu of focused item.
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        For exact search, add <code>"</code> in front of search.
                                                        (e.g. For <code>One Piece</code> type <code>"one</code>).
                                                    </li>
                                                    <li>
                                                        Paste link to set browse pasted link in Locations tab. Or
                                                        page link of a supported file to open it in reader
                                                        directly.
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        Type name ending with <code>{window.path.sep}</code> to
                                                        open it in search. e.g. When there is a directory named{" "}
                                    ...
                                    <li>
                                        Collapse/Un-collapse Bookmarks, History page tabs by clicking on the
                                        Dividers beside them in home screen.
                                    </li>
                                    <li>
                                        <b>Reader :</b>
                                        <ul>
                                            <li>
                                                When using the "vertical Scroll" mode, you can change chapters on
                                                the first or last page by clicking on either side of the screen or
                                                by clicking "prevPage" (
                                                <code>
                                                    {shortcuts.find((e) => e.command === "prevPage")?.key1}
                                                </code>
                                                {" , "}
                                                <code>
                                                ...
                                                <code>
                                                    {shortcuts.find((e) => e.command === "nextPage")?.key1}
                                                </code>
                                                {" , "}
                                                <code>
                                            ...
                                            <li>
                                                To scroll using mouse while viewing full page, use "Left to Right"
                                                or "Right to Left" reading mode, then "Fit Vertically" option or
                                                make image size lower than window height.
                                            </li>
                                            <li>
                                                Access the side list by moving the mouse to left side of the
                                                screen. You can pin and resize the side list.
                                            </li>
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Note that this only opens the chapter containing images, not the
                                                Manga Folder.
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        theme, copy whole text you received and click on "Save Theme from
                                        Clipboard".
                                    </li>
                                    <li>
                                        <a
                                        ...
                                        Set the quality of the images. Higher number means higher quality but also
                                    ...
                                    <li id="settings-usage-anilist">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                manga and checking side-list (moving mouse to left most part of
                                                app).
                                            </li>
                                            <li>
                                                Tracker are managed according to the folder of manga. If manga
                                                folder is moved/renamed/deleted local tracker will be remove and
                                                user will need to add tracker again.
                                            </li>
                                            <li>
                                    ...
                                    <li id="settings-usage-customStylesheet">
                                        ...
                                        . You can use developer/inspect tool to check the element and existing
                                        styles.
                                        <br />
                                        NOTE: Do not move <code> .css </code> file in directly under app's folder.
                                        If you are using portable version, everything except <code>userdata</code>{" "}
                                        folder will be deleted. You can safely put it inside <code>userdata</code>{" "}
                                        folder.
                                    </li>
                                </ul>
                            </div>
